...
while opcao != 7:
    ...
    if opcao == 1:
        ...
        matricula = input("Qual a matrícula do aluno(a) a ser inserida no cadastro? ")
        ...
        for aluno in lista_alunos:
            ...
            nome = input("Qual o nome do aluno(a) a ser inserido no cadastro? ")
            curso = input("Qual o curso do aluno(a) a ser inserido no cadastro? ")
    ...
    # [2] Read: Shows a list item or the all the items in the list.
        ...
        while escolha != 3:
            print("[1] cadastro do aluno(a) / [2] banco de cadastros / [3] Voltar ao menu principal")
            escolha = int(input("Qual informação deseja consultar? "))

            if escolha == 1:
                print("")

                matricula = input("Insira a matrícula do aluno(a) para acessar seu cadastro ")
    ...
    # [3] Update: changes an index of a list element.
        ...
        while escolha != 3:
            ...
            escolha = int(input("Qual informação deseja alterar no cadastro? "))

            if escolha == 1:
                print("")

                matricula = input("Qual a matricula do aluno(a) a ter o nome alterado no cadastro? ")

                for aluno in lista_alunos:
                    if aluno[1] == matricula:
                        nome_new = input("Qual o novo nome do aluno(a) a ser inserido no cadastro? ")
                        aluno[0] = nome_new
                ...
                matricula = input("Qual a matricula do aluno(a) a ter o curso alterado no cadastro? ")

                for aluno in lista_alunos:
                    if aluno[1] == matricula:
                        curso_new = input("Qual o novo curso do aluno(a) a ser inserido no cadastro? ")
                        aluno[2] = curso_new
                        print("Cadastro alterado com sucesso!")
                        break
    ...
    # [4] Delete: erases an element of the list.
        ...
        matricula = input("Qual a matrícula do aluno(a) a ser removido do cadastro? ")
